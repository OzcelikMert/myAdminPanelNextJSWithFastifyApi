...
export default class PageSettingsPaths extends Component<IPageProps, IPageState> {
    ...
    async getSettings() {
        let serviceResult = await SettingService.get({langId: this.props.getStateApp.appData.currentLangId, projection: SettingProjectionKeys.Path}, this.abortController.signal)
    ...
    onSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        this.setState({
            ...
            let serviceResult = await SettingService.updatePath(this.state.formData, this.abortController.signal)
    ...
    onCreate() {
        this.setState((state: IPageState) => {
            state.formData.paths = [...state.formData.paths, {
                _id: String.createId(),
                title: "",
                key: "",
                path: "",
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <ComponentFormType
                                ...
                                onChange={e => this.onInputChange(props.contents, "asPath", e.target.value)}
                            />
                        </div>
                    </div>
                </ComponentFieldSet>
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-md-12 mt-3">
                            <ComponentFormType
                                ...
                                value={props.path}
                                onChange={e => this.onInputChange(props, "path", e.target.value)}
                            />
                        </div>
                        <div className="col-md-12 mt-3">
                            <div className="row">

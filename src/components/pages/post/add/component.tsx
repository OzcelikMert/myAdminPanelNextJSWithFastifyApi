                ...
                <div className="row">
                    <div className="col-md-9">
                        <ComponentFormSelect
                            ...
                            value={this.props.page.state.components?.filter(item => item.value == _id)}
                            onChange={(item: any, e) => this.onChangeSelect(item.value, index)}
                        />
                    </div>
                    <div className="col-md-3 mt-2">
                        <div className="row">
                            <div className="col-6">
                                {
                                    _id && PermissionUtil.check(
                                        this.props.page.props.getStateApp.sessionAuth!,
                                        ComponentEndPointPermission.UPDATE
                                    ) ? <a href={EndPoints.COMPONENT_WITH.EDIT(_id)} target="_blank" className="btn btn-gradient-warning btn-lg">
                            ...
                            <div className="col-6 text-end">
                                <button type="button" className="btn btn-gradient-danger btn-lg"
                                        onClick={event => this.onDelete(index)}><i

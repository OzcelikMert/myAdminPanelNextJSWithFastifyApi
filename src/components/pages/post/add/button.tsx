                    ...
                    <div className="row mt-2">
                        <div className="col-md-6">
                            <ThemeFormType
                                ...
                                onChange={e => this.onChange("title", e.target.value, props.index)}
                            />
                        </div>
                        <div className="col-md-6 mt-3 mt-lg-0">
                            <ThemeFormType
                                ...
                                onChange={e => this.onChange("url", e.target.value, props.index)}
                            />
                        </div>
                    </div>
                </ThemeFieldSet>
                        ...
                        <div className="row mb-3">
                            <div className="col-md-7">
                                <button type={"button"} className="btn btn-gradient-success btn-lg"
                                        onClick={() => this.onAddNew()}>+ {this.props.page.props.t("newButton")}
                                </button>
                            </div>
                            <div className="col-md-7 mt-2">
                                <div className="row">
                                    {
                                        this.props.page.state.formData.contents.buttons?.map((button, index) => {

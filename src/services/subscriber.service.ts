...
const getMany = (params: ISubscriberGetManyParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const deleteWithId = (params: ISubscriberDeleteWithIdParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const deleteMany = (params: ISubscriberDeleteManyParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),

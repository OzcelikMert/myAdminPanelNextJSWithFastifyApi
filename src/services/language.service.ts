...
const getMany = (params: ILanguageGetManyParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const updateWithId = (params: ILanguageUpdateWithIdParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const updateRankWithId = (params: ILanguageUpdateRankWithIdParamService, signal?: AbortSignal) => {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),

...
const updateWithId = (params: INavigationUpdateWithIdParamService, signal?: AbortSignal) =>  {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const updateRankWithId = (params: INavigationUpdateRankWithIdParamService, signal?: AbortSignal) =>  {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const updateStatusMany = (params: INavigationUpdateStatusManyIdParamService, signal?: AbortSignal) =>  {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),
...
const deleteMany = (params: INavigationDeleteManyParamService, signal?: AbortSignal) =>  {
    return new ApiRequest({
        apiUrl: PathUtil.getApiURL(),

...
export class ApiEndPoints {
    ...
    static get AUTH_WITH() { return new AuthApiEndPoint(); }

    static get USER() { return "/user"; }
    static get USER_WITH() { return new UserApiEndPoint(); }

    static get POST() { return "/post"; }
    static get POST_WITH() { return new PostApiEndPoint(); }

    static get POST_TERM() { return "/post-term"; }
    static get POST_TERM_WITH() { return new PostTermApiEndPoint(); }

    static get GALLERY() { return "/gallery"; }
    static get GALLERY_WITH() { return new GalleryApiEndPoint(); }

    static get SETTING() { return "/setting"; }
    static get SETTING_WITH() { return new SettingApiEndPoint(); }
    ...
    static get SERVER_INFO_WITH() { return new ServerInfoApiEndPoint(); }

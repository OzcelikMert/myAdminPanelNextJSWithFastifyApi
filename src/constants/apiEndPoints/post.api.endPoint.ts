...
export class PostApiEndPoint {
    ...
    GET_PREV_NEXT_WITH_ID(_id: string) { return PathUtil.createPath(this.mainPath, `/get/prev-next/${_id}`); }
    ...
    UPDATE_PRODUCT_WITH_ID(_id: string) { return PathUtil.createPath(this.mainPath, `/update/product/${_id}`); }
